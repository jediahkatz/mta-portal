...
BACKGROUND_IMAGE = 'l-background.bmp'
...
text_lines = [
    ...
    adafruit_display_text.label.Label(font, color=colors[0], x=20, y=3, text="8th Ave"),
    adafruit_display_text.label.Label(font, color=colors[1], x=20, y=11, text="- mins"),
    adafruit_display_text.label.Label(font, color=colors[0], x=20, y=20, text="Bklyn"),
